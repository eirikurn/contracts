...
builtInFilters.skipExtraProps = function(value, schema) {
  var key
...
builtInFilters.skipExtraItems = function(value, schema) {
...
var validatorFilters = (function() {
  var prototype = require('validator').Filter.prototype
    , skip = ['convert', 'sanitize', 'modify']
    , filters = {}
    , key, fakeThis;
  fakeThis = { str: null, modify: function(str) { this.str = str; } };
